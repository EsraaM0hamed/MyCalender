...
public class ShowWeekViewEventsListAdapterE extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShowWeekViewEventsListAdapterE(Context context, ArrayList<ShowEventsModel> showEventsModelList) {
    ...
    class ShowEventsViewHolder extends RecyclerView.ViewHolder {
        ...
        public ShowEventsViewHolder(View itemView) {
            super(itemView);
            ll_parrent = (LinearLayout) itemView.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.ll_parrent);
        ...
        public void setShowEvents(final ShowEventsModel model) {
            ...
            View row_event_layout = LayoutInflater.from(context).inflate(com.desai.vatsal.mydynamiccalendar.R.layout.day_week_event, null, false);

            TextView tv_event_simbol = (TextView) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.tv_event_simbol);
            TextView tv_event_name = (TextView) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.tv_event_name);
            TextView tv_event_date = (TextView) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.tv_event_date);
            TextView tv_event_time = (TextView) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.tv_event_time);
            LinearLayout ll_month_events = (LinearLayout) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.ll_month_events);
            View v_divider = (View) row_event_layout.findViewById(com.desai.vatsal.mydynamiccalendar.R.id.v_divider);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(context).inflate(com.desai.vatsal.mydynamiccalendar.R.layout.row_week_view_show_events, parent, false);
        return new ShowWeekViewEventsListAdapterE.ShowEventsViewHolder(v);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ShowWeekViewEventsListAdapterE.ShowEventsViewHolder showEventsViewHolder = (ShowWeekViewEventsListAdapterE.ShowEventsViewHolder) holder;
